 ...
 */
async function createAesForParty(keyPair: Elliptic.KeyPair, publicKey: Buffer) {
  ...
  return {
    encrypt: async (data: ArrayBuffer | Uint8Array) => {
    ...
    decrypt: async (data: ArrayBuffer | Uint8Array) => {
      // data should be an ArrayBuffer or TypedArray
